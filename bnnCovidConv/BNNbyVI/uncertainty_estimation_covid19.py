...
def init_dataset(notcovid19_dir):
    ...
    covid19_set, _, _, _ = dat.getDataset('covid193fc')
...
def run(net_type, weight_path, notcovid19_dir):
    ...
    trainset, testset, inputs, outputs = dat.getDataset('covid193fc')
    ...
    sample_notcovid19, truth_notcovid19, idx = get_sample(notcovid19_set, sample_type='covid193fc')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--net_type', default='3fc', type=str, help='model')
    parser.add_argument('--weights_path', default='./checkpoints/covid19/bayesian/model_3fc_bbb_softplus.pt', type=str, help='weights for model')
