...
from models.BayesianModels.Bayesian3FC import BBB3FC
...
def getModel(net_type, inputs, outputs, priors, layer_type, activation_type):
    if (net_type == 'lenet'):
        ...
        return BBB3FC(outputs, inputs, priors, layer_type, activation_type)
    else:
...
def run(dataset, net_type):
    ...
    lr_sched = lr_scheduler.ReduceLROnPlateau(optimizer, patience=5, verbose=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='covid19', type=str, help='dataset = [MNIST/CIFAR10/CIFAR100]')
