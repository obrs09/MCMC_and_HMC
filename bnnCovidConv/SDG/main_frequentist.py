...
from models.NonBayesianModels.ThreeFC import ThreeFC
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='covid19', type=str, help='dataset = [MNIST/CIFAR10/CIFAR100/covid193fc/covid19]')
