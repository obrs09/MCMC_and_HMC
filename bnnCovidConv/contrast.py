...
plt.plot(fpr_SGLD[threshold5], tpr_SGLD[threshold5], 'X', color='red')
plt.plot(fpr_pSGLD[threshold5], tpr_pSGLD[threshold5], 'X', color='blue')
plt.plot(fpr_SGHMC[threshold5], tpr_SGHMC[threshold5], 'X', color='green')
plt.plot(fpr_BBB[threshold5], tpr_BBB[threshold5], 'X', color='orange')
