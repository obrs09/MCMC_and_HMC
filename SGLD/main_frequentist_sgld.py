...
from pysgmcmc.optimizers import sgld
#import pysgmcmc
...
def run(dataset, net_type):
    ...
    ckpt_name = f'checkpoints/{dataset}/frequentist/model_{net_type}_sgld.pt'
    ...
    optimizer = sgld.SGLD(net.parameters(), lr=lr, precondition_decay_rate=0.95, num_pseudo_batches=1, num_burn_in_steps=5000, diagonal_bias=1e-08)
